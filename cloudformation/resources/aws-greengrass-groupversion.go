...
func (r *AWSGreengrassGroupVersion) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSGreengrassGroupVersion) SetResourceCondition(condition string) {
...
func (r *AWSGreengrassGroupVersion) DeletionPolicy() policies.DeletionPolicy {
