...
func (r *AWSOpsWorksApp_Source) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSOpsWorksApp_Source) SetResourceCondition(condition string) {
...
func (r *AWSOpsWorksApp_Source) DeletionPolicy() policies.DeletionPolicy {
