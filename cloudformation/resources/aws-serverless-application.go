...
func (r *AWSServerlessApplication) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSServerlessApplication) SetResourceCondition(condition string) {
...
func (r *AWSServerlessApplication) DeletionPolicy() policies.DeletionPolicy {
