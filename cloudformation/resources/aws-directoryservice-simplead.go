...
func (r *AWSDirectoryServiceSimpleAD) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSDirectoryServiceSimpleAD) SetResourceCondition(condition string) {
...
func (r *AWSDirectoryServiceSimpleAD) DeletionPolicy() policies.DeletionPolicy {
