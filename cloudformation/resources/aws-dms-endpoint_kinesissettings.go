...
func (r *AWSDMSEndpoint_KinesisSettings) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSDMSEndpoint_KinesisSettings) SetResourceCondition(condition string) {
...
func (r *AWSDMSEndpoint_KinesisSettings) DeletionPolicy() policies.DeletionPolicy {
