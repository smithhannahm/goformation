...
func (r *AWSAppMeshVirtualNode_Logging) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSAppMeshVirtualNode_Logging) SetResourceCondition(condition string) {
...
func (r *AWSAppMeshVirtualNode_Logging) DeletionPolicy() policies.DeletionPolicy {
