...
func (r *AWSConfigRemediationConfiguration_SsmControls) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSConfigRemediationConfiguration_SsmControls) SetResourceCondition(condition string) {
...
func (r *AWSConfigRemediationConfiguration_SsmControls) DeletionPolicy() policies.DeletionPolicy {
