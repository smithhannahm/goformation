...
func (r *AWSApiGatewayV2RouteResponse_ParameterConstraints) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSApiGatewayV2RouteResponse_ParameterConstraints) SetResourceCondition(condition string) {
