...
type AWSECSTaskDefinition_LogConfiguration struct {
	...
	SecretOptions []AWSECSTaskDefinition_Secret `json:"SecretOptions,omitempty"`
...
func (r *AWSECSTaskDefinition_LogConfiguration) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSECSTaskDefinition_LogConfiguration) SetResourceCondition(condition string) {
...
func (r *AWSECSTaskDefinition_LogConfiguration) DeletionPolicy() policies.DeletionPolicy {
	return r._deletionPolicy
}

// SetDeletionPolicy applies an AWS CloudFormation DeletionPolicy to this resource
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html
func (r *AWSECSTaskDefinition_LogConfiguration) SetDeletionPolicy(policy policies.DeletionPolicy) {
