...
func (r *AWSAmazonMQBroker_User) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSAmazonMQBroker_User) SetResourceCondition(condition string) {
...
func (r *AWSAmazonMQBroker_User) DeletionPolicy() policies.DeletionPolicy {
