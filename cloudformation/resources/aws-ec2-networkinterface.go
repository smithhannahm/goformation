...
func (r *AWSEC2NetworkInterface) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSEC2NetworkInterface) SetResourceCondition(condition string) {
...
func (r *AWSEC2NetworkInterface) DeletionPolicy() policies.DeletionPolicy {
