...
func (r *AWSAppStreamFleet_ComputeCapacity) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSAppStreamFleet_ComputeCapacity) SetResourceCondition(condition string) {
...
func (r *AWSAppStreamFleet_ComputeCapacity) DeletionPolicy() policies.DeletionPolicy {
