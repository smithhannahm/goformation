...
func (r *AWSAppMeshRoute_WeightedTarget) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSAppMeshRoute_WeightedTarget) SetResourceCondition(condition string) {
...
func (r *AWSAppMeshRoute_WeightedTarget) DeletionPolicy() policies.DeletionPolicy {
