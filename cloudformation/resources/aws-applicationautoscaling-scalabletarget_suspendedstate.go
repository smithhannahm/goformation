...
func (r *AWSApplicationAutoScalingScalableTarget_SuspendedState) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSApplicationAutoScalingScalableTarget_SuspendedState) SetResourceCondition(condition string) {
