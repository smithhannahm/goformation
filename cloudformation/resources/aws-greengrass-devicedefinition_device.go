...
func (r *AWSGreengrassDeviceDefinition_Device) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSGreengrassDeviceDefinition_Device) SetResourceCondition(condition string) {
...
func (r *AWSGreengrassDeviceDefinition_Device) DeletionPolicy() policies.DeletionPolicy {
