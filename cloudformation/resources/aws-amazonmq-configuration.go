...
func (r *AWSAmazonMQConfiguration) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSAmazonMQConfiguration) SetResourceCondition(condition string) {
...
func (r *AWSAmazonMQConfiguration) DeletionPolicy() policies.DeletionPolicy {
