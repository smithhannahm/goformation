...
func (r *AWSEC2LaunchTemplate_HibernationOptions) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSEC2LaunchTemplate_HibernationOptions) SetResourceCondition(condition string) {
