...
func (r *AWSGlueSecurityConfiguration_CloudWatchEncryption) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSGlueSecurityConfiguration_CloudWatchEncryption) SetResourceCondition(condition string) {
...
func (r *AWSGlueSecurityConfiguration_CloudWatchEncryption) DeletionPolicy() policies.DeletionPolicy {
