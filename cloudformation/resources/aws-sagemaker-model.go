...
func (r *AWSSageMakerModel) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSSageMakerModel) SetResourceCondition(condition string) {
...
func (r *AWSSageMakerModel) DeletionPolicy() policies.DeletionPolicy {
