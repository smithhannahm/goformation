...
func (r *AWSApiGatewayUsagePlanKey) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSApiGatewayUsagePlanKey) SetResourceCondition(condition string) {
...
func (r *AWSApiGatewayUsagePlanKey) DeletionPolicy() policies.DeletionPolicy {
