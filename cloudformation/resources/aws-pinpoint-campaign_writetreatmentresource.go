...
func (r *AWSPinpointCampaign_WriteTreatmentResource) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSPinpointCampaign_WriteTreatmentResource) SetResourceCondition(condition string) {
...
func (r *AWSPinpointCampaign_WriteTreatmentResource) DeletionPolicy() policies.DeletionPolicy {
