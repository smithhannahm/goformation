...
func (r *AWSLambdaFunction) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSLambdaFunction) SetResourceCondition(condition string) {
...
func (r *AWSLambdaFunction) DeletionPolicy() policies.DeletionPolicy {
