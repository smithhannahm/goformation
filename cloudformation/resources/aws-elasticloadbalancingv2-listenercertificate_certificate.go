...
func (r *AWSElasticLoadBalancingV2ListenerCertificate_Certificate) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSElasticLoadBalancingV2ListenerCertificate_Certificate) SetResourceCondition(condition string) {
