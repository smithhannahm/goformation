...
func (r *AWSKinesisAnalyticsApplication_RecordColumn) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSKinesisAnalyticsApplication_RecordColumn) SetResourceCondition(condition string) {
...
func (r *AWSKinesisAnalyticsApplication_RecordColumn) DeletionPolicy() policies.DeletionPolicy {
