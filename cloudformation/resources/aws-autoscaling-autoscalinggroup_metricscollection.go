...
func (r *AWSAutoScalingAutoScalingGroup_MetricsCollection) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSAutoScalingAutoScalingGroup_MetricsCollection) SetResourceCondition(condition string) {
...
func (r *AWSAutoScalingAutoScalingGroup_MetricsCollection) DeletionPolicy() policies.DeletionPolicy {
