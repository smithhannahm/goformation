...
func (r *AWSDynamoDBTable_TimeToLiveSpecification) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSDynamoDBTable_TimeToLiveSpecification) SetResourceCondition(condition string) {
...
func (r *AWSDynamoDBTable_TimeToLiveSpecification) DeletionPolicy() policies.DeletionPolicy {
