...
func (r *AWSGreengrassResourceDefinition_LocalVolumeResourceData) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSGreengrassResourceDefinition_LocalVolumeResourceData) SetResourceCondition(condition string) {
...
func (r *AWSGreengrassResourceDefinition_LocalVolumeResourceData) DeletionPolicy() policies.DeletionPolicy {
