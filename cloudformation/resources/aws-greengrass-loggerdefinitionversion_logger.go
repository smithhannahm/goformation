...
func (r *AWSGreengrassLoggerDefinitionVersion_Logger) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSGreengrassLoggerDefinitionVersion_Logger) SetResourceCondition(condition string) {
...
func (r *AWSGreengrassLoggerDefinitionVersion_Logger) DeletionPolicy() policies.DeletionPolicy {
