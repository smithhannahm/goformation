...
func (r *AWSAppStreamFleet_DomainJoinInfo) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSAppStreamFleet_DomainJoinInfo) SetResourceCondition(condition string) {
...
func (r *AWSAppStreamFleet_DomainJoinInfo) DeletionPolicy() policies.DeletionPolicy {
