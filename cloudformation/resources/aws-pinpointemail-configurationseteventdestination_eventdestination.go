...
func (r *AWSPinpointEmailConfigurationSetEventDestination_EventDestination) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSPinpointEmailConfigurationSetEventDestination_EventDestination) SetResourceCondition(condition string) {
...
func (r *AWSPinpointEmailConfigurationSetEventDestination_EventDestination) DeletionPolicy() policies.DeletionPolicy {
