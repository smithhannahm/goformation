...
func (r *AWSAppStreamStack) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSAppStreamStack) SetResourceCondition(condition string) {
...
func (r *AWSAppStreamStack) DeletionPolicy() policies.DeletionPolicy {
