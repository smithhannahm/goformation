...
func (r *AWSElasticsearchDomain) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSElasticsearchDomain) SetResourceCondition(condition string) {
...
func (r *AWSElasticsearchDomain) DeletionPolicy() policies.DeletionPolicy {
