...
func (r *AWSKinesisStream_StreamEncryption) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSKinesisStream_StreamEncryption) SetResourceCondition(condition string) {
...
func (r *AWSKinesisStream_StreamEncryption) DeletionPolicy() policies.DeletionPolicy {
