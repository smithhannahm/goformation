...
func (r *AWSGreengrassResourceDefinition_ResourceDefinitionVersion) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSGreengrassResourceDefinition_ResourceDefinitionVersion) SetResourceCondition(condition string) {
...
func (r *AWSGreengrassResourceDefinition_ResourceDefinitionVersion) DeletionPolicy() policies.DeletionPolicy {
