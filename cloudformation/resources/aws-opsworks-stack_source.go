...
func (r *AWSOpsWorksStack_Source) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSOpsWorksStack_Source) SetResourceCondition(condition string) {
...
func (r *AWSOpsWorksStack_Source) DeletionPolicy() policies.DeletionPolicy {
