...
func (r *AWSAutoScalingScalingPolicy) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSAutoScalingScalingPolicy) SetResourceCondition(condition string) {
...
func (r *AWSAutoScalingScalingPolicy) DeletionPolicy() policies.DeletionPolicy {
