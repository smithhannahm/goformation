...
func (r *AWSCognitoUserPool_SchemaAttribute) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSCognitoUserPool_SchemaAttribute) SetResourceCondition(condition string) {
...
func (r *AWSCognitoUserPool_SchemaAttribute) DeletionPolicy() policies.DeletionPolicy {
