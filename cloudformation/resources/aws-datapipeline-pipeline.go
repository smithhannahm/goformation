...
func (r *AWSDataPipelinePipeline) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSDataPipelinePipeline) SetResourceCondition(condition string) {
...
func (r *AWSDataPipelinePipeline) DeletionPolicy() policies.DeletionPolicy {
