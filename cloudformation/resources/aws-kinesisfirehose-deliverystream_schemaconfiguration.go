...
func (r *AWSKinesisFirehoseDeliveryStream_SchemaConfiguration) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSKinesisFirehoseDeliveryStream_SchemaConfiguration) SetResourceCondition(condition string) {
...
func (r *AWSKinesisFirehoseDeliveryStream_SchemaConfiguration) DeletionPolicy() policies.DeletionPolicy {
