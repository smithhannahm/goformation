...
func (r *AWSAppMeshVirtualService_VirtualServiceProvider) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSAppMeshVirtualService_VirtualServiceProvider) SetResourceCondition(condition string) {
...
func (r *AWSAppMeshVirtualService_VirtualServiceProvider) DeletionPolicy() policies.DeletionPolicy {
