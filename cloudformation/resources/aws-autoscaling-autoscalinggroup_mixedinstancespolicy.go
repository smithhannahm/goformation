...
func (r *AWSAutoScalingAutoScalingGroup_MixedInstancesPolicy) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSAutoScalingAutoScalingGroup_MixedInstancesPolicy) SetResourceCondition(condition string) {
