...
func (r *AWSECSService_NetworkConfiguration) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSECSService_NetworkConfiguration) SetResourceCondition(condition string) {
...
func (r *AWSECSService_NetworkConfiguration) DeletionPolicy() policies.DeletionPolicy {
