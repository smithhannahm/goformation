...
func (r *AWSAppMeshVirtualService_VirtualServiceSpec) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSAppMeshVirtualService_VirtualServiceSpec) SetResourceCondition(condition string) {
...
func (r *AWSAppMeshVirtualService_VirtualServiceSpec) DeletionPolicy() policies.DeletionPolicy {
