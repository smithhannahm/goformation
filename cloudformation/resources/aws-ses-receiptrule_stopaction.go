...
func (r *AWSSESReceiptRule_StopAction) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSSESReceiptRule_StopAction) SetResourceCondition(condition string) {
...
func (r *AWSSESReceiptRule_StopAction) DeletionPolicy() policies.DeletionPolicy {
