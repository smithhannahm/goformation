...
func (r *AWSElastiCacheReplicationGroup) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSElastiCacheReplicationGroup) SetResourceCondition(condition string) {
...
func (r *AWSElastiCacheReplicationGroup) DeletionPolicy() policies.DeletionPolicy {
