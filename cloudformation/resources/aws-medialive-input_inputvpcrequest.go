...
func (r *AWSMediaLiveInput_InputVpcRequest) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSMediaLiveInput_InputVpcRequest) SetResourceCondition(condition string) {
...
func (r *AWSMediaLiveInput_InputVpcRequest) DeletionPolicy() policies.DeletionPolicy {
