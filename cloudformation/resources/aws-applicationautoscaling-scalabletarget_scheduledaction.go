...
func (r *AWSApplicationAutoScalingScalableTarget_ScheduledAction) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSApplicationAutoScalingScalableTarget_ScheduledAction) SetResourceCondition(condition string) {
...
func (r *AWSApplicationAutoScalingScalableTarget_ScheduledAction) DeletionPolicy() policies.DeletionPolicy {
