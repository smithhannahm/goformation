...
// AWSPinpointSegment_Demographic AWS CloudFormation Resource (AWS::Pinpoint::Segment.Demographic)
...
type AWSPinpointSegment_Demographic struct {
	...
	AppVersion *AWSPinpointSegment_SetDimension `json:"AppVersion,omitempty"`
	...
	Channel *AWSPinpointSegment_SetDimension `json:"Channel,omitempty"`
	...
	DeviceType *AWSPinpointSegment_SetDimension `json:"DeviceType,omitempty"`
	...
	Make *AWSPinpointSegment_SetDimension `json:"Make,omitempty"`
	...
	Model *AWSPinpointSegment_SetDimension `json:"Model,omitempty"`
	...
	Platform *AWSPinpointSegment_SetDimension `json:"Platform,omitempty"`
...
func (r *AWSPinpointSegment_Demographic) AWSCloudFormationType() string {
	return "AWS::Pinpoint::Segment.Demographic"
}

// Condition returns the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSPinpointSegment_Demographic) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSPinpointSegment_Demographic) SetResourceCondition(condition string) {
	r._resourceCondition = condition
}

// DependsOn returns a slice of logical ID names this resource depends on.
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-dependson.html
func (r *AWSPinpointSegment_Demographic) DependsOn() []string {
	return r._dependsOn
}

// SetDependsOn specify that the creation of this resource follows another.
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-dependson.html
func (r *AWSPinpointSegment_Demographic) SetDependsOn(dependencies []string) {
	r._dependsOn = dependencies
}

// Metadata returns the metadata associated with this resource.
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-metadata.html
func (r *AWSPinpointSegment_Demographic) Metadata() map[string]interface{} {
	return r._metadata
}

// SetMetadata enables you to associate structured data with this resource.
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-metadata.html
func (r *AWSPinpointSegment_Demographic) SetMetadata(metadata map[string]interface{}) {
	r._metadata = metadata
}

// DeletionPolicy returns the AWS CloudFormation DeletionPolicy to this resource
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html
func (r *AWSPinpointSegment_Demographic) DeletionPolicy() policies.DeletionPolicy {
	return r._deletionPolicy
}

// SetDeletionPolicy applies an AWS CloudFormation DeletionPolicy to this resource
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html
func (r *AWSPinpointSegment_Demographic) SetDeletionPolicy(policy policies.DeletionPolicy) {
