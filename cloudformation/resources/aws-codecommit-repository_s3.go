...
func (r *AWSCodeCommitRepository_S3) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSCodeCommitRepository_S3) SetResourceCondition(condition string) {
...
func (r *AWSCodeCommitRepository_S3) DeletionPolicy() policies.DeletionPolicy {
