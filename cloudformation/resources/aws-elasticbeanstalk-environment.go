...
func (r *AWSElasticBeanstalkEnvironment) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSElasticBeanstalkEnvironment) SetResourceCondition(condition string) {
...
func (r *AWSElasticBeanstalkEnvironment) DeletionPolicy() policies.DeletionPolicy {
