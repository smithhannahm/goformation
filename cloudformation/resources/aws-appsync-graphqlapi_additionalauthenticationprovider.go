...
func (r *AWSAppSyncGraphQLApi_AdditionalAuthenticationProvider) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSAppSyncGraphQLApi_AdditionalAuthenticationProvider) SetResourceCondition(condition string) {
