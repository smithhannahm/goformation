...
func (r *AWSCognitoUserPool_DeviceConfiguration) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSCognitoUserPool_DeviceConfiguration) SetResourceCondition(condition string) {
...
func (r *AWSCognitoUserPool_DeviceConfiguration) DeletionPolicy() policies.DeletionPolicy {
