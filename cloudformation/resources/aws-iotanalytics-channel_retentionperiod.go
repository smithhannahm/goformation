...
func (r *AWSIoTAnalyticsChannel_RetentionPeriod) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSIoTAnalyticsChannel_RetentionPeriod) SetResourceCondition(condition string) {
...
func (r *AWSIoTAnalyticsChannel_RetentionPeriod) DeletionPolicy() policies.DeletionPolicy {
