...
func (r *AWSManagedBlockchainMember_MemberFrameworkConfiguration) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSManagedBlockchainMember_MemberFrameworkConfiguration) SetResourceCondition(condition string) {
...
func (r *AWSManagedBlockchainMember_MemberFrameworkConfiguration) DeletionPolicy() policies.DeletionPolicy {
