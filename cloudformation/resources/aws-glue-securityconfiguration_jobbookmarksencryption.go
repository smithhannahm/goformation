...
func (r *AWSGlueSecurityConfiguration_JobBookmarksEncryption) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSGlueSecurityConfiguration_JobBookmarksEncryption) SetResourceCondition(condition string) {
...
func (r *AWSGlueSecurityConfiguration_JobBookmarksEncryption) DeletionPolicy() policies.DeletionPolicy {
