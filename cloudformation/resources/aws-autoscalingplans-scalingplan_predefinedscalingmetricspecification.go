...
func (r *AWSAutoScalingPlansScalingPlan_PredefinedScalingMetricSpecification) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSAutoScalingPlansScalingPlan_PredefinedScalingMetricSpecification) SetResourceCondition(condition string) {
...
func (r *AWSAutoScalingPlansScalingPlan_PredefinedScalingMetricSpecification) DeletionPolicy() policies.DeletionPolicy {
