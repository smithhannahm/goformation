...
// AWSPinpointApplicationSettings AWS CloudFormation Resource (AWS::Pinpoint::ApplicationSettings)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-applicationsettings.html
type AWSPinpointApplicationSettings struct {
	...
	CampaignHook *AWSPinpointApplicationSettings_CampaignHook `json:"CampaignHook,omitempty"`
	...
	Limits *AWSPinpointApplicationSettings_Limits `json:"Limits,omitempty"`
	...
	QuietTime *AWSPinpointApplicationSettings_QuietTime `json:"QuietTime,omitempty"`
...
func (r *AWSPinpointApplicationSettings) AWSCloudFormationType() string {
	return "AWS::Pinpoint::ApplicationSettings"
}

// Condition returns the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSPinpointApplicationSettings) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSPinpointApplicationSettings) SetResourceCondition(condition string) {
	r._resourceCondition = condition
}

// DependsOn returns a slice of logical ID names this resource depends on.
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-dependson.html
func (r *AWSPinpointApplicationSettings) DependsOn() []string {
	return r._dependsOn
}

// SetDependsOn specify that the creation of this resource follows another.
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-dependson.html
func (r *AWSPinpointApplicationSettings) SetDependsOn(dependencies []string) {
	r._dependsOn = dependencies
}

// Metadata returns the metadata associated with this resource.
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-metadata.html
func (r *AWSPinpointApplicationSettings) Metadata() map[string]interface{} {
	return r._metadata
}

// SetMetadata enables you to associate structured data with this resource.
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-metadata.html
func (r *AWSPinpointApplicationSettings) SetMetadata(metadata map[string]interface{}) {
	r._metadata = metadata
}

// DeletionPolicy returns the AWS CloudFormation DeletionPolicy to this resource
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html
func (r *AWSPinpointApplicationSettings) DeletionPolicy() policies.DeletionPolicy {
	return r._deletionPolicy
}

// SetDeletionPolicy applies an AWS CloudFormation DeletionPolicy to this resource
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html
func (r *AWSPinpointApplicationSettings) SetDeletionPolicy(policy policies.DeletionPolicy) {
	r._deletionPolicy = policy
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AWSPinpointApplicationSettings) MarshalJSON() ([]byte, error) {
	type Properties AWSPinpointApplicationSettings
...
func (r *AWSPinpointApplicationSettings) UnmarshalJSON(b []byte) error {
	type Properties AWSPinpointApplicationSettings
	res := &struct {
		Type           string
		Properties     *Properties
	...
	if res.Properties != nil {
		*r = AWSPinpointApplicationSettings(*res.Properties)
	}
	if res.Condition != "" {
