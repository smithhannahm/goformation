...
func (r *AWSGreengrassFunctionDefinition_RunAs) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSGreengrassFunctionDefinition_RunAs) SetResourceCondition(condition string) {
...
func (r *AWSGreengrassFunctionDefinition_RunAs) DeletionPolicy() policies.DeletionPolicy {
