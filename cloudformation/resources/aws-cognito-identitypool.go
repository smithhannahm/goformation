...
func (r *AWSCognitoIdentityPool) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSCognitoIdentityPool) SetResourceCondition(condition string) {
...
func (r *AWSCognitoIdentityPool) DeletionPolicy() policies.DeletionPolicy {
