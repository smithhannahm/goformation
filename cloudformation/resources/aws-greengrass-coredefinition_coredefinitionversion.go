...
func (r *AWSGreengrassCoreDefinition_CoreDefinitionVersion) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSGreengrassCoreDefinition_CoreDefinitionVersion) SetResourceCondition(condition string) {
...
func (r *AWSGreengrassCoreDefinition_CoreDefinitionVersion) DeletionPolicy() policies.DeletionPolicy {
