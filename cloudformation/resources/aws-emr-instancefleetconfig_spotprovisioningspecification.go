...
func (r *AWSEMRInstanceFleetConfig_SpotProvisioningSpecification) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSEMRInstanceFleetConfig_SpotProvisioningSpecification) SetResourceCondition(condition string) {
...
func (r *AWSEMRInstanceFleetConfig_SpotProvisioningSpecification) DeletionPolicy() policies.DeletionPolicy {
