...
func (r *AWSIoTEventsDetectorModel_Action) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSIoTEventsDetectorModel_Action) SetResourceCondition(condition string) {
...
func (r *AWSIoTEventsDetectorModel_Action) DeletionPolicy() policies.DeletionPolicy {
