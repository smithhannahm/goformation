...
func (r *AWSKinesisAnalyticsV2ApplicationReferenceDataSource_MappingParameters) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSKinesisAnalyticsV2ApplicationReferenceDataSource_MappingParameters) SetResourceCondition(condition string) {
...
func (r *AWSKinesisAnalyticsV2ApplicationReferenceDataSource_MappingParameters) DeletionPolicy() policies.DeletionPolicy {
