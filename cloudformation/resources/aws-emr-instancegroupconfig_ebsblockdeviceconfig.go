...
func (r *AWSEMRInstanceGroupConfig_EbsBlockDeviceConfig) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSEMRInstanceGroupConfig_EbsBlockDeviceConfig) SetResourceCondition(condition string) {
...
func (r *AWSEMRInstanceGroupConfig_EbsBlockDeviceConfig) DeletionPolicy() policies.DeletionPolicy {
