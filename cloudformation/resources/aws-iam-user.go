...
func (r *AWSIAMUser) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSIAMUser) SetResourceCondition(condition string) {
...
func (r *AWSIAMUser) DeletionPolicy() policies.DeletionPolicy {
