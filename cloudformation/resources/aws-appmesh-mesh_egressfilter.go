...
func (r *AWSAppMeshMesh_EgressFilter) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSAppMeshMesh_EgressFilter) SetResourceCondition(condition string) {
...
func (r *AWSAppMeshMesh_EgressFilter) DeletionPolicy() policies.DeletionPolicy {
