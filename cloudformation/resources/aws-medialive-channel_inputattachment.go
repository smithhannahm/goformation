...
// AWSMediaLiveChannel_InputAttachment AWS CloudFormation Resource (AWS::MediaLive::Channel.InputAttachment)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-medialive-channel-inputattachment.html
type AWSMediaLiveChannel_InputAttachment struct {
	...
	InputSettings *AWSMediaLiveChannel_InputSettings `json:"InputSettings,omitempty"`
...
func (r *AWSMediaLiveChannel_InputAttachment) AWSCloudFormationType() string {
	return "AWS::MediaLive::Channel.InputAttachment"
}

// Condition returns the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSMediaLiveChannel_InputAttachment) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSMediaLiveChannel_InputAttachment) SetResourceCondition(condition string) {
...
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html
func (r *AWSMediaLiveChannel_InputAttachment) SetDeletionPolicy(policy policies.DeletionPolicy) {
