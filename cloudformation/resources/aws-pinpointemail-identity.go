...
func (r *AWSPinpointEmailIdentity) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSPinpointEmailIdentity) SetResourceCondition(condition string) {
...
func (r *AWSPinpointEmailIdentity) DeletionPolicy() policies.DeletionPolicy {
