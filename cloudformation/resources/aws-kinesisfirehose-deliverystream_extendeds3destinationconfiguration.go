...
type AWSKinesisFirehoseDeliveryStream_ExtendedS3DestinationConfiguration struct {
	...
	DataFormatConversionConfiguration *AWSKinesisFirehoseDeliveryStream_DataFormatConversionConfiguration `json:"DataFormatConversionConfiguration,omitempty"`
...
func (r *AWSKinesisFirehoseDeliveryStream_ExtendedS3DestinationConfiguration) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSKinesisFirehoseDeliveryStream_ExtendedS3DestinationConfiguration) SetResourceCondition(condition string) {
