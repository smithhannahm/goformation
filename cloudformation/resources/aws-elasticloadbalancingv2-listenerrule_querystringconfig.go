...
func (r *AWSElasticLoadBalancingV2ListenerRule_QueryStringConfig) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSElasticLoadBalancingV2ListenerRule_QueryStringConfig) SetResourceCondition(condition string) {
...
func (r *AWSElasticLoadBalancingV2ListenerRule_QueryStringConfig) DeletionPolicy() policies.DeletionPolicy {
