...
func (r *AWSBackupBackupSelection_BackupSelectionResourceType) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSBackupBackupSelection_BackupSelectionResourceType) SetResourceCondition(condition string) {
...
func (r *AWSBackupBackupSelection_BackupSelectionResourceType) DeletionPolicy() policies.DeletionPolicy {
