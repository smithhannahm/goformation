...
func (r *AWSIoT1ClickProject) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSIoT1ClickProject) SetResourceCondition(condition string) {
...
func (r *AWSIoT1ClickProject) DeletionPolicy() policies.DeletionPolicy {
