...
// AWSConfigOrganizationConfigRule AWS CloudFormation Resource (AWS::Config::OrganizationConfigRule)
...
type AWSConfigOrganizationConfigRule struct {
	...
	OrganizationCustomRuleMetadata *AWSConfigOrganizationConfigRule_OrganizationCustomRuleMetadata `json:"OrganizationCustomRuleMetadata,omitempty"`
	...
	OrganizationManagedRuleMetadata *AWSConfigOrganizationConfigRule_OrganizationManagedRuleMetadata `json:"OrganizationManagedRuleMetadata,omitempty"`
...
func (r *AWSConfigOrganizationConfigRule) AWSCloudFormationType() string {
	return "AWS::Config::OrganizationConfigRule"
}

// Condition returns the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSConfigOrganizationConfigRule) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSConfigOrganizationConfigRule) SetResourceCondition(condition string) {
	r._resourceCondition = condition
}

// DependsOn returns a slice of logical ID names this resource depends on.
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-dependson.html
func (r *AWSConfigOrganizationConfigRule) DependsOn() []string {
	return r._dependsOn
}

// SetDependsOn specify that the creation of this resource follows another.
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-dependson.html
func (r *AWSConfigOrganizationConfigRule) SetDependsOn(dependencies []string) {
	r._dependsOn = dependencies
}

// Metadata returns the metadata associated with this resource.
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-metadata.html
func (r *AWSConfigOrganizationConfigRule) Metadata() map[string]interface{} {
	return r._metadata
}

// SetMetadata enables you to associate structured data with this resource.
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-metadata.html
func (r *AWSConfigOrganizationConfigRule) SetMetadata(metadata map[string]interface{}) {
	r._metadata = metadata
}

// DeletionPolicy returns the AWS CloudFormation DeletionPolicy to this resource
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html
func (r *AWSConfigOrganizationConfigRule) DeletionPolicy() policies.DeletionPolicy {
	return r._deletionPolicy
}

// SetDeletionPolicy applies an AWS CloudFormation DeletionPolicy to this resource
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html
func (r *AWSConfigOrganizationConfigRule) SetDeletionPolicy(policy policies.DeletionPolicy) {
	r._deletionPolicy = policy
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AWSConfigOrganizationConfigRule) MarshalJSON() ([]byte, error) {
	type Properties AWSConfigOrganizationConfigRule
...
func (r *AWSConfigOrganizationConfigRule) UnmarshalJSON(b []byte) error {
	type Properties AWSConfigOrganizationConfigRule
	res := &struct {
		Type           string
		Properties     *Properties
	...
	if res.Properties != nil {
		*r = AWSConfigOrganizationConfigRule(*res.Properties)
	}
	if res.Condition != "" {
