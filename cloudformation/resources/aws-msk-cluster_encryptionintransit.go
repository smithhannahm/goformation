...
func (r *AWSMSKCluster_EncryptionInTransit) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSMSKCluster_EncryptionInTransit) SetResourceCondition(condition string) {
...
func (r *AWSMSKCluster_EncryptionInTransit) DeletionPolicy() policies.DeletionPolicy {
