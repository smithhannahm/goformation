...
func (r *AWSPinpointSegment_Recency) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSPinpointSegment_Recency) SetResourceCondition(condition string) {
...
func (r *AWSPinpointSegment_Recency) DeletionPolicy() policies.DeletionPolicy {
