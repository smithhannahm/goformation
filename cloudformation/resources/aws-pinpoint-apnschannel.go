...
func (r *AWSPinpointAPNSChannel) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSPinpointAPNSChannel) SetResourceCondition(condition string) {
...
func (r *AWSPinpointAPNSChannel) DeletionPolicy() policies.DeletionPolicy {
