...
func (r *AWSGlueSecurityConfiguration_EncryptionConfiguration) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSGlueSecurityConfiguration_EncryptionConfiguration) SetResourceCondition(condition string) {
...
func (r *AWSGlueSecurityConfiguration_EncryptionConfiguration) DeletionPolicy() policies.DeletionPolicy {
