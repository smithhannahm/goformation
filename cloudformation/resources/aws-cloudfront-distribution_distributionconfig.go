...
func (r *AWSCloudFrontDistribution_DistributionConfig) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSCloudFrontDistribution_DistributionConfig) SetResourceCondition(condition string) {
