...
func (r *AWSGluePartition) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSGluePartition) SetResourceCondition(condition string) {
...
func (r *AWSGluePartition) DeletionPolicy() policies.DeletionPolicy {
