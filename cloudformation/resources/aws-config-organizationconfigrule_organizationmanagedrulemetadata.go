...
func (r *AWSConfigOrganizationConfigRule_OrganizationManagedRuleMetadata) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSConfigOrganizationConfigRule_OrganizationManagedRuleMetadata) SetResourceCondition(condition string) {
