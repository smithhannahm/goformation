...
func (r *AWSRoute53HealthCheck) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSRoute53HealthCheck) SetResourceCondition(condition string) {
...
func (r *AWSRoute53HealthCheck) DeletionPolicy() policies.DeletionPolicy {
