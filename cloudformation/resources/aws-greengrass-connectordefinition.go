...
func (r *AWSGreengrassConnectorDefinition) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSGreengrassConnectorDefinition) SetResourceCondition(condition string) {
...
func (r *AWSGreengrassConnectorDefinition) DeletionPolicy() policies.DeletionPolicy {
