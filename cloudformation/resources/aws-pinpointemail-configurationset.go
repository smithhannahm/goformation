...
func (r *AWSPinpointEmailConfigurationSet) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSPinpointEmailConfigurationSet) SetResourceCondition(condition string) {
...
func (r *AWSPinpointEmailConfigurationSet) DeletionPolicy() policies.DeletionPolicy {
