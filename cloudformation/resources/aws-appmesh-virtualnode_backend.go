...
func (r *AWSAppMeshVirtualNode_Backend) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSAppMeshVirtualNode_Backend) SetResourceCondition(condition string) {
...
func (r *AWSAppMeshVirtualNode_Backend) DeletionPolicy() policies.DeletionPolicy {
