...
func (r *AWSMSKCluster_Tls) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSMSKCluster_Tls) SetResourceCondition(condition string) {
...
func (r *AWSMSKCluster_Tls) DeletionPolicy() policies.DeletionPolicy {
