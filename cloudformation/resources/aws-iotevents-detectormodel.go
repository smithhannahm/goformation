...
// AWSIoTEventsDetectorModel AWS CloudFormation Resource (AWS::IoTEvents::DetectorModel)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iotevents-detectormodel.html
type AWSIoTEventsDetectorModel struct {
	...
	DetectorModelDefinition *AWSIoTEventsDetectorModel_DetectorModelDefinition `json:"DetectorModelDefinition,omitempty"`
...
func (r *AWSIoTEventsDetectorModel) AWSCloudFormationType() string {
	return "AWS::IoTEvents::DetectorModel"
}

// Condition returns the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSIoTEventsDetectorModel) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSIoTEventsDetectorModel) SetResourceCondition(condition string) {
	r._resourceCondition = condition
}

// DependsOn returns a slice of logical ID names this resource depends on.
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-dependson.html
func (r *AWSIoTEventsDetectorModel) DependsOn() []string {
	return r._dependsOn
}

// SetDependsOn specify that the creation of this resource follows another.
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-dependson.html
func (r *AWSIoTEventsDetectorModel) SetDependsOn(dependencies []string) {
	r._dependsOn = dependencies
}

// Metadata returns the metadata associated with this resource.
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-metadata.html
func (r *AWSIoTEventsDetectorModel) Metadata() map[string]interface{} {
	return r._metadata
}

// SetMetadata enables you to associate structured data with this resource.
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-metadata.html
func (r *AWSIoTEventsDetectorModel) SetMetadata(metadata map[string]interface{}) {
	r._metadata = metadata
}

// DeletionPolicy returns the AWS CloudFormation DeletionPolicy to this resource
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html
func (r *AWSIoTEventsDetectorModel) DeletionPolicy() policies.DeletionPolicy {
	return r._deletionPolicy
}

// SetDeletionPolicy applies an AWS CloudFormation DeletionPolicy to this resource
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html
func (r *AWSIoTEventsDetectorModel) SetDeletionPolicy(policy policies.DeletionPolicy) {
	r._deletionPolicy = policy
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AWSIoTEventsDetectorModel) MarshalJSON() ([]byte, error) {
	type Properties AWSIoTEventsDetectorModel
...
func (r *AWSIoTEventsDetectorModel) UnmarshalJSON(b []byte) error {
	type Properties AWSIoTEventsDetectorModel
	res := &struct {
		Type           string
		Properties     *Properties
	...
	if res.Properties != nil {
		*r = AWSIoTEventsDetectorModel(*res.Properties)
	}
	if res.Condition != "" {
