...
func (r *AWSEC2EC2Fleet_FleetLaunchTemplateSpecificationRequest) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSEC2EC2Fleet_FleetLaunchTemplateSpecificationRequest) SetResourceCondition(condition string) {
...
func (r *AWSEC2EC2Fleet_FleetLaunchTemplateSpecificationRequest) DeletionPolicy() policies.DeletionPolicy {
	return r._deletionPolicy
}

// SetDeletionPolicy applies an AWS CloudFormation DeletionPolicy to this resource
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html
func (r *AWSEC2EC2Fleet_FleetLaunchTemplateSpecificationRequest) SetDeletionPolicy(policy policies.DeletionPolicy) {
