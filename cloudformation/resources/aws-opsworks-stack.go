...
func (r *AWSOpsWorksStack) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSOpsWorksStack) SetResourceCondition(condition string) {
...
func (r *AWSOpsWorksStack) DeletionPolicy() policies.DeletionPolicy {
