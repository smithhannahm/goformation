...
func (r *AWSEMRInstanceFleetConfig_Configuration) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSEMRInstanceFleetConfig_Configuration) SetResourceCondition(condition string) {
...
func (r *AWSEMRInstanceFleetConfig_Configuration) DeletionPolicy() policies.DeletionPolicy {
