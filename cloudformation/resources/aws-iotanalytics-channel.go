...
type AWSIoTAnalyticsChannel struct {
	...
	ChannelStorage *AWSIoTAnalyticsChannel_ChannelStorage `json:"ChannelStorage,omitempty"`
...
func (r *AWSIoTAnalyticsChannel) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSIoTAnalyticsChannel) SetResourceCondition(condition string) {
...
func (r *AWSIoTAnalyticsChannel) DeletionPolicy() policies.DeletionPolicy {
	return r._deletionPolicy
}

// SetDeletionPolicy applies an AWS CloudFormation DeletionPolicy to this resource
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html
func (r *AWSIoTAnalyticsChannel) SetDeletionPolicy(policy policies.DeletionPolicy) {
