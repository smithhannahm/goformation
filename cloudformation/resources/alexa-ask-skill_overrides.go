...
func (r *AlexaASKSkill_Overrides) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AlexaASKSkill_Overrides) SetResourceCondition(condition string) {
...
func (r *AlexaASKSkill_Overrides) DeletionPolicy() policies.DeletionPolicy {
