...
func (r *AWSElasticLoadBalancingV2Listener_RedirectConfig) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSElasticLoadBalancingV2Listener_RedirectConfig) SetResourceCondition(condition string) {
...
func (r *AWSElasticLoadBalancingV2Listener_RedirectConfig) DeletionPolicy() policies.DeletionPolicy {
	return r._deletionPolicy
}

// SetDeletionPolicy applies an AWS CloudFormation DeletionPolicy to this resource
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html
func (r *AWSElasticLoadBalancingV2Listener_RedirectConfig) SetDeletionPolicy(policy policies.DeletionPolicy) {
