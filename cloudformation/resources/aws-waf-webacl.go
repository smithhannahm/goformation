...
func (r *AWSWAFWebACL) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSWAFWebACL) SetResourceCondition(condition string) {
...
func (r *AWSWAFWebACL) DeletionPolicy() policies.DeletionPolicy {
