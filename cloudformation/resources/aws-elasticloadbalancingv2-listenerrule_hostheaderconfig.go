...
func (r *AWSElasticLoadBalancingV2ListenerRule_HostHeaderConfig) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSElasticLoadBalancingV2ListenerRule_HostHeaderConfig) SetResourceCondition(condition string) {
