...
func (r *AWSCodePipelinePipeline_ArtifactStoreMap) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSCodePipelinePipeline_ArtifactStoreMap) SetResourceCondition(condition string) {
...
func (r *AWSCodePipelinePipeline_ArtifactStoreMap) DeletionPolicy() policies.DeletionPolicy {
	return r._deletionPolicy
}

// SetDeletionPolicy applies an AWS CloudFormation DeletionPolicy to this resource
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html
func (r *AWSCodePipelinePipeline_ArtifactStoreMap) SetDeletionPolicy(policy policies.DeletionPolicy) {
