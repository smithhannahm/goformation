...
func (r *AWSIoTAnalyticsPipeline_Filter) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSIoTAnalyticsPipeline_Filter) SetResourceCondition(condition string) {
...
func (r *AWSIoTAnalyticsPipeline_Filter) DeletionPolicy() policies.DeletionPolicy {
