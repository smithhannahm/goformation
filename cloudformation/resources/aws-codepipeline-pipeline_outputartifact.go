...
func (r *AWSCodePipelinePipeline_OutputArtifact) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSCodePipelinePipeline_OutputArtifact) SetResourceCondition(condition string) {
...
func (r *AWSCodePipelinePipeline_OutputArtifact) DeletionPolicy() policies.DeletionPolicy {
