...
func (r *AWSLakeFormationDataLakeSettings_DataLakePrincipal) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSLakeFormationDataLakeSettings_DataLakePrincipal) SetResourceCondition(condition string) {
...
func (r *AWSLakeFormationDataLakeSettings_DataLakePrincipal) DeletionPolicy() policies.DeletionPolicy {
