...
func (r *AWSApiGatewayVpcLink) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSApiGatewayVpcLink) SetResourceCondition(condition string) {
...
func (r *AWSApiGatewayVpcLink) DeletionPolicy() policies.DeletionPolicy {
