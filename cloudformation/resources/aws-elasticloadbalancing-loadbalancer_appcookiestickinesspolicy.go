...
func (r *AWSElasticLoadBalancingLoadBalancer_AppCookieStickinessPolicy) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSElasticLoadBalancingLoadBalancer_AppCookieStickinessPolicy) SetResourceCondition(condition string) {
...
func (r *AWSElasticLoadBalancingLoadBalancer_AppCookieStickinessPolicy) DeletionPolicy() policies.DeletionPolicy {
