...
func (r *AWSSageMakerWorkteam_CognitoMemberDefinition) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSSageMakerWorkteam_CognitoMemberDefinition) SetResourceCondition(condition string) {
