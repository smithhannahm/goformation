...
func (r *AWSIoTAnalyticsDataset_DeltaTime) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSIoTAnalyticsDataset_DeltaTime) SetResourceCondition(condition string) {
...
func (r *AWSIoTAnalyticsDataset_DeltaTime) DeletionPolicy() policies.DeletionPolicy {
