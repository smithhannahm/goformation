...
func (r *AWSECSTaskDefinition_DockerVolumeConfiguration) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSECSTaskDefinition_DockerVolumeConfiguration) SetResourceCondition(condition string) {
...
func (r *AWSECSTaskDefinition_DockerVolumeConfiguration) DeletionPolicy() policies.DeletionPolicy {
