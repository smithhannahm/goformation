...
func (r *AWSEC2SpotFleet_PrivateIpAddressSpecification) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSEC2SpotFleet_PrivateIpAddressSpecification) SetResourceCondition(condition string) {
