...
func (r *AWSDMSReplicationInstance) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSDMSReplicationInstance) SetResourceCondition(condition string) {
...
func (r *AWSDMSReplicationInstance) DeletionPolicy() policies.DeletionPolicy {
