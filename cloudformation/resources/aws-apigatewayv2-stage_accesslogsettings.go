...
func (r *AWSApiGatewayV2Stage_AccessLogSettings) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSApiGatewayV2Stage_AccessLogSettings) SetResourceCondition(condition string) {
