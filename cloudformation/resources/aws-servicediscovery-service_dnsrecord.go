...
func (r *AWSServiceDiscoveryService_DnsRecord) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSServiceDiscoveryService_DnsRecord) SetResourceCondition(condition string) {
...
func (r *AWSServiceDiscoveryService_DnsRecord) DeletionPolicy() policies.DeletionPolicy {
