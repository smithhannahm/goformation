...
func (r *AWSPinpointEmailConfigurationSet_SendingOptions) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSPinpointEmailConfigurationSet_SendingOptions) SetResourceCondition(condition string) {
...
func (r *AWSPinpointEmailConfigurationSet_SendingOptions) DeletionPolicy() policies.DeletionPolicy {
