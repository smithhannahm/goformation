...
func (r *AWSRoboMakerSimulationApplication_SimulationSoftwareSuite) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSRoboMakerSimulationApplication_SimulationSoftwareSuite) SetResourceCondition(condition string) {
...
func (r *AWSRoboMakerSimulationApplication_SimulationSoftwareSuite) DeletionPolicy() policies.DeletionPolicy {
