...
func (r *AWSDLMLifecyclePolicy_Parameters) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSDLMLifecyclePolicy_Parameters) SetResourceCondition(condition string) {
...
func (r *AWSDLMLifecyclePolicy_Parameters) DeletionPolicy() policies.DeletionPolicy {
