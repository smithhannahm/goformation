...
func (r *AWSPinpointApplicationSettings_Limits) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSPinpointApplicationSettings_Limits) SetResourceCondition(condition string) {
...
func (r *AWSPinpointApplicationSettings_Limits) DeletionPolicy() policies.DeletionPolicy {
