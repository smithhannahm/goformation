...
func (r *AWSS3Bucket_RedirectAllRequestsTo) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSS3Bucket_RedirectAllRequestsTo) SetResourceCondition(condition string) {
...
func (r *AWSS3Bucket_RedirectAllRequestsTo) DeletionPolicy() policies.DeletionPolicy {
