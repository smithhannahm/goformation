...
func (r *AWSEventsEventBusPolicy) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSEventsEventBusPolicy) SetResourceCondition(condition string) {
...
func (r *AWSEventsEventBusPolicy) DeletionPolicy() policies.DeletionPolicy {
