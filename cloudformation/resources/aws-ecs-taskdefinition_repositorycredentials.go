...
func (r *AWSECSTaskDefinition_RepositoryCredentials) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSECSTaskDefinition_RepositoryCredentials) SetResourceCondition(condition string) {
...
func (r *AWSECSTaskDefinition_RepositoryCredentials) DeletionPolicy() policies.DeletionPolicy {
