...
type AWSDLMLifecyclePolicy_PolicyDetails struct {
	...
	Parameters *AWSDLMLifecyclePolicy_Parameters `json:"Parameters,omitempty"`
...
func (r *AWSDLMLifecyclePolicy_PolicyDetails) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSDLMLifecyclePolicy_PolicyDetails) SetResourceCondition(condition string) {
...
func (r *AWSDLMLifecyclePolicy_PolicyDetails) DeletionPolicy() policies.DeletionPolicy {
