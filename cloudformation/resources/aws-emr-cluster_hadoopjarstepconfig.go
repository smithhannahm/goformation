...
func (r *AWSEMRCluster_HadoopJarStepConfig) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSEMRCluster_HadoopJarStepConfig) SetResourceCondition(condition string) {
...
func (r *AWSEMRCluster_HadoopJarStepConfig) DeletionPolicy() policies.DeletionPolicy {
