...
func (r *AWSGlueMLTransform_GlueTables) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSGlueMLTransform_GlueTables) SetResourceCondition(condition string) {
...
func (r *AWSGlueMLTransform_GlueTables) DeletionPolicy() policies.DeletionPolicy {
