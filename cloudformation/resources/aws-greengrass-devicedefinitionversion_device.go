...
func (r *AWSGreengrassDeviceDefinitionVersion_Device) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSGreengrassDeviceDefinitionVersion_Device) SetResourceCondition(condition string) {
...
func (r *AWSGreengrassDeviceDefinitionVersion_Device) DeletionPolicy() policies.DeletionPolicy {
