...
func (r *AWSDirectoryServiceMicrosoftAD) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSDirectoryServiceMicrosoftAD) SetResourceCondition(condition string) {
...
func (r *AWSDirectoryServiceMicrosoftAD) DeletionPolicy() policies.DeletionPolicy {
