...
func (r *AWSWAFRegionalByteMatchSet) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSWAFRegionalByteMatchSet) SetResourceCondition(condition string) {
...
func (r *AWSWAFRegionalByteMatchSet) DeletionPolicy() policies.DeletionPolicy {
