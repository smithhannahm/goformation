...
func (r *AWSEC2TransitGatewayAttachment) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSEC2TransitGatewayAttachment) SetResourceCondition(condition string) {
...
func (r *AWSEC2TransitGatewayAttachment) DeletionPolicy() policies.DeletionPolicy {
