...
func (r *AWSOpsWorksInstance) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSOpsWorksInstance) SetResourceCondition(condition string) {
...
func (r *AWSOpsWorksInstance) DeletionPolicy() policies.DeletionPolicy {
