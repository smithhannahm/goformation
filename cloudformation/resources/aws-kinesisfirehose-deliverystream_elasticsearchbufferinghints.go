...
func (r *AWSKinesisFirehoseDeliveryStream_ElasticsearchBufferingHints) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSKinesisFirehoseDeliveryStream_ElasticsearchBufferingHints) SetResourceCondition(condition string) {
...
func (r *AWSKinesisFirehoseDeliveryStream_ElasticsearchBufferingHints) DeletionPolicy() policies.DeletionPolicy {
	return r._deletionPolicy
}

// SetDeletionPolicy applies an AWS CloudFormation DeletionPolicy to this resource
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html
func (r *AWSKinesisFirehoseDeliveryStream_ElasticsearchBufferingHints) SetDeletionPolicy(policy policies.DeletionPolicy) {
