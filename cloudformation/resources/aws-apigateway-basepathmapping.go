...
func (r *AWSApiGatewayBasePathMapping) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSApiGatewayBasePathMapping) SetResourceCondition(condition string) {
...
func (r *AWSApiGatewayBasePathMapping) DeletionPolicy() policies.DeletionPolicy {
