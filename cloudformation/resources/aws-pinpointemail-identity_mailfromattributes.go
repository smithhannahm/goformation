...
func (r *AWSPinpointEmailIdentity_MailFromAttributes) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSPinpointEmailIdentity_MailFromAttributes) SetResourceCondition(condition string) {
