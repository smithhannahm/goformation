...
func (r *AWSGameLiftBuild_S3Location) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSGameLiftBuild_S3Location) SetResourceCondition(condition string) {
...
func (r *AWSGameLiftBuild_S3Location) DeletionPolicy() policies.DeletionPolicy {
