...
func (r *AWSAmplifyApp_EnvironmentVariable) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSAmplifyApp_EnvironmentVariable) SetResourceCondition(condition string) {
...
func (r *AWSAmplifyApp_EnvironmentVariable) DeletionPolicy() policies.DeletionPolicy {
