...
func (r *AWSOpsWorksStack_ElasticIp) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSOpsWorksStack_ElasticIp) SetResourceCondition(condition string) {
...
func (r *AWSOpsWorksStack_ElasticIp) DeletionPolicy() policies.DeletionPolicy {
