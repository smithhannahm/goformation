...
func (r *AWSAppSyncResolver) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSAppSyncResolver) SetResourceCondition(condition string) {
...
func (r *AWSAppSyncResolver) DeletionPolicy() policies.DeletionPolicy {
