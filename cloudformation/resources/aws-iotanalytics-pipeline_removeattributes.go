...
func (r *AWSIoTAnalyticsPipeline_RemoveAttributes) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSIoTAnalyticsPipeline_RemoveAttributes) SetResourceCondition(condition string) {
...
func (r *AWSIoTAnalyticsPipeline_RemoveAttributes) DeletionPolicy() policies.DeletionPolicy {
