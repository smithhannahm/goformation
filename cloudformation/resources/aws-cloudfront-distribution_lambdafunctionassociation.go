...
func (r *AWSCloudFrontDistribution_LambdaFunctionAssociation) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSCloudFrontDistribution_LambdaFunctionAssociation) SetResourceCondition(condition string) {
...
func (r *AWSCloudFrontDistribution_LambdaFunctionAssociation) DeletionPolicy() policies.DeletionPolicy {
	return r._deletionPolicy
}

// SetDeletionPolicy applies an AWS CloudFormation DeletionPolicy to this resource
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html
func (r *AWSCloudFrontDistribution_LambdaFunctionAssociation) SetDeletionPolicy(policy policies.DeletionPolicy) {
