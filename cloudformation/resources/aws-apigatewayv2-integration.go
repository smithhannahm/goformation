...
func (r *AWSApiGatewayV2Integration) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSApiGatewayV2Integration) SetResourceCondition(condition string) {
...
func (r *AWSApiGatewayV2Integration) DeletionPolicy() policies.DeletionPolicy {
