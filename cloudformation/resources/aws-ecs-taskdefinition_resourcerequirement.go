...
func (r *AWSECSTaskDefinition_ResourceRequirement) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSECSTaskDefinition_ResourceRequirement) SetResourceCondition(condition string) {
...
func (r *AWSECSTaskDefinition_ResourceRequirement) DeletionPolicy() policies.DeletionPolicy {
