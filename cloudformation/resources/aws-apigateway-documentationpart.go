...
func (r *AWSApiGatewayDocumentationPart) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSApiGatewayDocumentationPart) SetResourceCondition(condition string) {
...
func (r *AWSApiGatewayDocumentationPart) DeletionPolicy() policies.DeletionPolicy {
