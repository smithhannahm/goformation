...
func (r *AWSServerlessFunction_CloudWatchEventEvent) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSServerlessFunction_CloudWatchEventEvent) SetResourceCondition(condition string) {
...
func (r *AWSServerlessFunction_CloudWatchEventEvent) DeletionPolicy() policies.DeletionPolicy {
	return r._deletionPolicy
}

// SetDeletionPolicy applies an AWS CloudFormation DeletionPolicy to this resource
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html
func (r *AWSServerlessFunction_CloudWatchEventEvent) SetDeletionPolicy(policy policies.DeletionPolicy) {
