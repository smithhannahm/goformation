...
func (r *AWSKinesisAnalyticsV2Application_SqlApplicationConfiguration) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSKinesisAnalyticsV2Application_SqlApplicationConfiguration) SetResourceCondition(condition string) {
