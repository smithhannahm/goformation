...
func (r *AWSServerlessApi_Auth) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSServerlessApi_Auth) SetResourceCondition(condition string) {
...
func (r *AWSServerlessApi_Auth) DeletionPolicy() policies.DeletionPolicy {
