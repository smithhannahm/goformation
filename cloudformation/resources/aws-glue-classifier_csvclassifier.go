...
func (r *AWSGlueClassifier_CsvClassifier) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSGlueClassifier_CsvClassifier) SetResourceCondition(condition string) {
...
func (r *AWSGlueClassifier_CsvClassifier) DeletionPolicy() policies.DeletionPolicy {
