...
func (r *AWSCodeBuildProject_GitSubmodulesConfig) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSCodeBuildProject_GitSubmodulesConfig) SetResourceCondition(condition string) {
...
func (r *AWSCodeBuildProject_GitSubmodulesConfig) DeletionPolicy() policies.DeletionPolicy {
