...
func (r *AWSBatchJobDefinition_ContainerProperties) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSBatchJobDefinition_ContainerProperties) SetResourceCondition(condition string) {
