...
func (r *AWSBackupBackupPlan_LifecycleResourceType) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSBackupBackupPlan_LifecycleResourceType) SetResourceCondition(condition string) {
...
func (r *AWSBackupBackupPlan_LifecycleResourceType) DeletionPolicy() policies.DeletionPolicy {
