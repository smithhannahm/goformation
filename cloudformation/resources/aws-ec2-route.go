...
func (r *AWSEC2Route) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSEC2Route) SetResourceCondition(condition string) {
...
func (r *AWSEC2Route) DeletionPolicy() policies.DeletionPolicy {
