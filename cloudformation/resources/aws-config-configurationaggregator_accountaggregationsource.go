...
func (r *AWSConfigConfigurationAggregator_AccountAggregationSource) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSConfigConfigurationAggregator_AccountAggregationSource) SetResourceCondition(condition string) {
...
func (r *AWSConfigConfigurationAggregator_AccountAggregationSource) DeletionPolicy() policies.DeletionPolicy {
