...
func (r *AWSIoTAnalyticsDataset_S3DestinationConfiguration) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *AWSIoTAnalyticsDataset_S3DestinationConfiguration) SetResourceCondition(condition string) {
...
func (r *AWSIoTAnalyticsDataset_S3DestinationConfiguration) DeletionPolicy() policies.DeletionPolicy {
